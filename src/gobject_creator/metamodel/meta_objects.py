...
class Interface(_Clif):
    ...
    def getExtendedIntfs(self, inRecursive=False):
        ...
        if not inRecursive:
            ...
            for intf in list(self._interfaces.values()):
...
PUBLIC, PROTECTED, PRIVATE = list(range(1, 4))
    
INSTANCE, STATIC = list(range(1, 3))
...
PROP_POINTER, \
PROP_OBJECT, \
PROP_ENUM = list(range(7))

PROP_ACCESS_READ, \
PROP_ACCESS_CONSTRUCTOR, \
PROP_ACCESS_READ_WRITE = list(range(3))
